(function() {
    ...
    // 3. LOGIKA SKANOWANIA
    function scan() {
        // Szukamy grafiki piórka (Items.png)
        const items = document.querySelectorAll('div[style*="Items.png"]');
    ...
    display.addEventListener('click', () => {
        ...
        if (!isInspecting) {
            ...
            // POWRÓT DO POSTACI (niezależnie od skina)
    ...
    console.log("%c[MFO3 Radar] Uruchomiono poprawnie!", "color: #00ffea; font-weight: bold;");
})();
