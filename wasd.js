...
// @version      7.0
// @description  Wstrzykuje ruch bezpośrednio do kontenera map-frame z obsługą panelu
// @author       Ropuch1
// @match        *://*.mfo3.pl/*
// @grant        none
// @run-at       document-end
...
(function() {
    ...
    // --- 2. TWÓJ ORYGINALNY KOD WASD (BEZ ZMIAN) ---
    const keyMap = {
    ...
    const handleKey = (e) => {
        // Dodana tylko jedna blokada: czy WASD jest włączone w panelu
    ...
    console.log("MFO3 WASD 7.0: Injection targeted at #map-frame");
})();
